...
var node = svg.append("g").attr("class", "nodes").selectAll("circle").data(graph.nodes).enter().append("circle").attr("r", 6).call(d3.drag().on("start", function dragstarted(d) {
...
/******/ });
//# sourceMappingURL=test-49cc301a580222f945b4.js.map