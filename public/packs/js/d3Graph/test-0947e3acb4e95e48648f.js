...
d3.json("/characters/all/d3json#", function (error, graph) {
  ...
  function ticked() {
    ...
    .style("stroke", "#969696").style("stroke-width", "1px").style("text-align", "center").attr("cx", function (d) {
      return d.x = Math.max(radius, Math.min(mywidth - radius, d.x));
    }).attr("cy", function (d) {
      return d.y = Math.max(radius, Math.min(myheight - radius, d.x));
    });
...
/******/ });
//# sourceMappingURL=test-0947e3acb4e95e48648f.js.map