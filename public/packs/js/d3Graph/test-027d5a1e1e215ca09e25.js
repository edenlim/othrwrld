...
function dblclick(d) {
  ...
  if (d.fixed == true) {
    ...
    d.fixed = true;
    console.log(d);
    console.log(d3.select(this).select("circle").style);
    d3.select(this).select("circle").style("background-color", "red");
    console.log(d3.select(this).select("circle").style);
  }
}
...
/******/ });
//# sourceMappingURL=test-027d5a1e1e215ca09e25.js.map