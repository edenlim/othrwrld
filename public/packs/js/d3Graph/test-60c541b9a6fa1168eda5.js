...
function ticked() {
  ...
  node.attr("r", 10).style("fill", "#ccc").style("stroke", "#969696").style("stroke-width", "1px").style("text-align", "center").attr("cx", function (d) {
    return d.x + 6;
  }).attr("cy", function (d) {
    return d.y - 6;
  });
...
/******/ });
//# sourceMappingURL=test-60c541b9a6fa1168eda5.js.map