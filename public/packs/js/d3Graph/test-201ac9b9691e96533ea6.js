...
var simulation = d3.forceSimulation().force("link", d3.forceLink().id(function (d) {
  return d.id;
})).force("charge", d3.forceManyBody().strength(-400)).force("center", d3.forceCenter(100 / 2, 100 / 2)); // d3.json("/characters/all/d3json#", function(error, graph) {
...
/******/ });
//# sourceMappingURL=test-201ac9b9691e96533ea6.js.map