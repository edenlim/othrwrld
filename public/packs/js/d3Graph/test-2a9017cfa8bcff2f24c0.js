...
var simulation = d3.forceSimulation().force("link", d3.forceLink().id(function (d) {
  return d.id;
})).force("charge", d3.forceManyBody().strength(-50)).force("center", d3.forceCenter(800 / 2, 800 / 2)); // d3.json("/characters/all/d3json#", function(error, graph) {
...
function ticked() {
  ...
  node.attr("r", 10).style("fill", "#000000").style("stroke", "#969696").style("stroke-width", "1px").style("text-align", "center").attr("cx", function (d) {
    return d.x + 6;
  }).attr("cy", function (d) {
    return d.y - 6;
  });
...
/******/ });
//# sourceMappingURL=test-2a9017cfa8bcff2f24c0.js.map