...
var simulation = d3.forceSimulation().force("link", d3.forceLink().id(function (d) {
  return d.id;
})).force("charge", d3.forceManyBody().strength(-200)).force("center", d3.forceCenter(800 / 2, 800 / 2)); // d3.json("/characters/all/d3json#", function(error, graph) {
...
/******/ });
//# sourceMappingURL=test-35ffb9bb668e9799eef7.js.map