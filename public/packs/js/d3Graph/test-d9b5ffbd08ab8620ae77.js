...
function dblclick(d) {
  ...
  if (d.fixed == true) {
    ...
    d.fy = d.y;
    d.fixed = true;
    console.log(d3.select(this)["_groups"][0][0]); // d3.select(this)["_groups"][0][0].style("fill", "red")

    d3.select(this).select("_groups").select("circle").style("fill", "red");
  }
}
...
/******/ });
//# sourceMappingURL=test-d9b5ffbd08ab8620ae77.js.map