...
var simulation = d3.forceSimulation().force("link", d3.forceLink().id(function (d) {
  return d.id;
})).force("charge", d3.forceManyBody()).force("center", d3.forceCenter(width / 2, height / 2)); //d3.json(jsonvar, function(error, graph) {
...
/******/ });
//# sourceMappingURL=test-8f29b09cc89562c856fb.js.map