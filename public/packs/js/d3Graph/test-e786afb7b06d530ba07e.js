...
var simulation = d3.forceSimulation().force("link", d3.forceLink().id(function (d) {
  return d.id;
})).force("charge", d3.forceManyBody().strength(-400)).force("center", d3.forceCenter(width, height)); //d3.json(jsonvar, function(error, graph) {
...
/******/ });
//# sourceMappingURL=test-e786afb7b06d530ba07e.js.map