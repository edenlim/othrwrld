...
var simulation = d3.forceSimulation().force("link", d3.forceLink().id(function (d) {
  return d.id;
})).force("charge", d3.forceManyBody().strength(-800)).force("center", d3.forceCenter(800 / 2, 800 / 2)); // d3.json("/characters/all/d3json#", function(error, graph) {
...
/******/ });
//# sourceMappingURL=test-ac5e83a5521f9df258c3.js.map