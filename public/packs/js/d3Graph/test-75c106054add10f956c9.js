...
var simulation = d3.forceSimulation().force("link", d3.forceLink().id(function (d) {
  return d.id;
})).force().linkDistance(50).force("charge", d3.forceManyBody().strength(-50)).force("center", d3.forceCenter(800 / 2, 800 / 2));
d3.json("/characters/all/d3json#", function (error, graph) {
  if (error) throw error; // var newLinks = graph.links.filter((link)=>{
...
/******/ });
//# sourceMappingURL=test-75c106054add10f956c9.js.map